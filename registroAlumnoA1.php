...
if ($result_check->num_rows > 0) {
    ...
    header("Location: AlumnosA1.php?error=Matrícula%20ya%20registrada");
    exit();
} else {
    ...
    if ($stmt_insert->execute()) {
        ...
        header("Location: AlumnosA1.php?status=success");
    } else {
        // Redirige a la página anterior con un mensaje de error en caso de fallo en la inserción
        header("Location: AlumnosA1.php?error=Error%20al%20registrar");
    }
