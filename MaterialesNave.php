                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarMaterialNave.php" method="POST">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="editarMaterialNave.php?id=<?php echo $mostrar['ItemID'] ?>">Editar</a>
                                                    </td>
                                                    <td>
                                                        <form action="EliminarMaterialNave.php" method="post">
