                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarHerramientaA1.php" method="POST" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarHerramientaA1.php?id=<?php echo $mostrar['ItemID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarHerramientaA1.php" method="post">
