    ...
    <nav class="sidebar" id="sidebar">
        <div id="navegador">
            ...
            <ul>
                ...
                <li>
                    <a href="PrestamoH.php"><img src="imagenes/herramientas2.png" alt=""> Prestamo Herramienta</a>
                </li>
            </ul>
        </div>
    </nav>
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="registroAlumnoA1.php" method="POST" enctype="multipart/form-data">
