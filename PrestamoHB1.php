...
$sql_roles1 = "SELECT ItemID, Nombre, Descripcion, Stock, EdificioID FROM herramientas Where EdificioID = 2";
...
<body>
    ...
    <div class="main-panel">
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarPrestamoHB1.php" method="POST" enctype="multipart/form-data">
        ...
        JOIN carreras ON estudiantes.CarreraID = carreras.CarreraID Where prestamosherramientas.EdificioID = 2";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form id="estadoForm<?php echo $row['PrestamoID']; ?>" action="procesar_estadoB1.php" method="post">
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarPHB1.php?id=<?php echo $row['PrestamoID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarPHB1.php" method="post">
