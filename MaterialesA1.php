...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="search-container">
            <form action="MaterialesA1.php" method="GET">
    ...
    <div class="main-panel">
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarMaterialA1.php" method="POST" enctype="multipart/form-data">
        ...
        WHERE materiales.EdificioID = 1"; // Primera condición fija
                ...
                OR edificios.NombreEdificio LIKE '%$search%')";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarMaterialA1.php?id=<?php echo $mostrar['ItemID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarMaterialA1.php" method="post">
