...
<body>
    ...
    <div class="main-panel">
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarPrestamoMB1.php" method="POST" enctype="multipart/form-data">
        ...
        JOIN carreras ON estudiantes.CarreraID = carreras.CarreraID  Where prestamosmateriales.EdificioID = 2";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarPMB1.php?id=<?php echo $row['PrestamoID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarPMB1.php" method="post">
