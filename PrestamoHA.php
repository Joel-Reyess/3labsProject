...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="search-container">
            <form action="PrestamoHA.php" method="GET">
    ...
    <div class="main-panel">
        ...
        WHERE prestamosherramientas.Estado = 'activo'"; // Estado se aplica siempre
            ...
            $sql .= " ORDER BY prestamosherramientas.FechaPrestamo DESC"; // Ordenar por fecha de préstamo ascendente
        ...
        JOIN estudiantes ON prestamosherramientas.Matricula = estudiantes.Matricula
        JOIN carreras ON estudiantes.CarreraID = carreras.CarreraID
        WHERE prestamosherramientas.Estado = 'inactivo'"; // Estado se aplica siempre
                ...
                // Agregar cláusula ORDER BY
                $sql .= " ORDER BY prestamosherramientas.FechaDevolucion DESC"; // Ordenar por fecha de préstamo ascendente
