...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['txtItemID']) && !empty($_POST['txtItemID'])) {
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                ...
                $stock = "0"; // Si no se encuentra el stock
            }
        } else {
            echo "Error en la consulta de stock.";
        }
        $stmt->close();
    }
}
...
$sql_roles1 = "SELECT ItemID, Nombre, Descripcion, Stock FROM Materiales";
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarPrestamoMA.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control bg-light" name="txtEdificio">
                                        <?php
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarPMA.php?id=<?php echo $row['PrestamoID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarPMA.php" method="post">
