...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="search-container">
            <form action="IndexA2.php" method="GET">
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarHerramientaA2.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="table-responsive pt-3">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        WHERE herramientas.EdificioID = 2";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarHerramientaA2.php?id=<?php echo $mostrar['ItemID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarHerramientaA2.php" method="post">
