...
<body>
    ...
    <div class="main-panel">
                ...
                <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="AgregarHerramienta.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <h4 class="card-title">Registro de Herramienta</h4>
            <p class="card-description">
                <code></code>
            </p>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarHerramienta.php?id=<?php echo $mostrar['ItemID'] ?>">Editar</a>
                                </td>
                                <td>
                                    <form action="EliminarHerramienta.php" method="post">
