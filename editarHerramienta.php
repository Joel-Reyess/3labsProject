...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <div id="navegador">
            ...
            <ul>
                <li><a href="Alumnos.php"><img src="imagenes/casa-icon.png" alt="" srcset=""> Inicio</a>
                </li>
                <li>
                ...
                <li>
                    <a href="PrestamoHA"><img src="imagenes/herramientas2.png" alt=""> Prestamo Herramienta</a>
                </li>
            </ul>
        </div>
    </nav>
                    ...
                    <div class="col-md-12 col-lg-12  grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="procesar_editarHAA.php" method="POST">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control bg-light" value="<?php echo $mostrar['ItemID'] ?>" id="Nombre" name="txtItemID" Required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bg-light" value="<?php echo $mostrar['Descripcion'] ?>" id="Descripcion" name="txtDescripcion" Required>
                                    </div>
                                    <div class="form-group">
